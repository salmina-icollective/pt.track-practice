...
WebUI.setText(findTestObject('Object Repository/D_Projects/Page_Point POSM/input_Login_email'), 'raeesa@pointgroup.biz')

WebUI.setEncryptedText(findTestObject('Object Repository/D_Projects/Page_Point POSM/input_Login_password'), 'aeHFOx8jV/A=')

WebUI.click(findTestObject('Object Repository/D_Projects/Page_Point POSM/button_Sign in'))
