...
WebUI.selectOptionByIndex(findTestObject('Category_TC/Page_Point POSM/input_Client_'), 0)

WebUI.setText(findTestObject('Object Repository/Category_TC/Page_Point POSM/input_Category'), 'Dairy')

WebUI.click(findTestObject('Object Repository/Category_TC/Page_Point POSM/input_Brand'))

WebUI.click(findTestObject('Object Repository/Category_TC/Page_Point POSM/button_Save'))
