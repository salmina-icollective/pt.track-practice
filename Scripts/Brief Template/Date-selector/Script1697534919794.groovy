...
String cMonth = WebUI.getText(findTestObject('Add brief template/Page_Point POSM/datePicker'))

String cYear = WebUI.getText(findTestObject('Add brief template/Page_Point POSM/itemDate'))
